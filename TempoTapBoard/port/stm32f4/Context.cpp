...
static const uint32_t InitialExcReturnValue = 0xFFFFFFFDU; // Return to Thread mode, exception return uses non-floating-point state and execution uses PSP after return.
                                    ...
                                    void (*exitPoint) (void))
{
   ...
   HardwareStackFrame *hardwareFrame = (HardwareStackFrame *) HardwareFrameLocation;
   hardwareFrame->r0 = 0;
   hardwareFrame->r1 = 1;
   hardwareFrame->r2 = 2;
   hardwareFrame->r3 = 3;
