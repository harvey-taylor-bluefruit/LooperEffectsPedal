...
const uint32_t Clocks::SystemClockFrequency_Hz = 180000000U;
const uint32_t Clocks::PeripheralBusAPB1ClockFrequency_Hz = Clocks::SystemClockFrequency_Hz / 4U;
const uint32_t Clocks::PeripheralBusAPB2ClockFrequency_Hz = Clocks::SystemClockFrequency_Hz / 2U;
 ...
 */
   ...
   const uint8_t PllSourceHSI = 0u;
   const uint32_t pllSource = PllSourceHSI;
...
static void SwitchSystemClockToPLL()
{
   ...
   // Configure Flash prefetch, ART accelerator and wait states
   uint32_t flashConfig = 
      FLASH_ACR_ARTEN | FLASH_ACR_PRFTEN | FLASH_ACR_LATENCY_5WS;
